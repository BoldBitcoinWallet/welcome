          ...
          <div className="flex flex-wrap justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.4s' }}>
            {storeButtons.map((button) => (
              <a
                ...
                className="group flex items-center justify-center space-x-3 bg-white/10 backdrop-blur-md hover:bg-white/20 px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-white/20 cursor-pointer w-40"
              >
                {button.useEmoji ? (
