      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <p className="text-gray-400 text-sm uppercase tracking-wider mb-4">
            FOSS Self-Custody Ecosystem
          </p>
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">
            PSBT-Compatible <span className="text-accent">Wallets</span>
          </h2>
          <p className="text-gray-400 text-sm max-w-xl mx-auto">
            Free and open-source (FOSS) self-custody Bitcoin wallets that
            support PSBT for interoperable multisig workflows
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5 max-w-6xl mx-auto">
            {wallets.map((wallet, index) => {
              const WalletLogo = () => {
                ...
                const hasTint =
                  wallet.tintColor && wallet.tintColor.trim() !== "";
